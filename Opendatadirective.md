...
De [Open Data Directive (ODD, *Open Data richtlijn*)](https://eur-lex.europa.eu/legal-content/EN/TXT/?qid=1561563110433&uri=CELEX:32019L1024) is aangenomen in 2019. De Nederlandse [Wet Hergebruik van Overheidsinformatie](https://wetten.overheid.nl/BWBR0036795/2021-07-01/0) is de plek waar deze richtlijn moet worden omgezet in de Nederlandse wetgeving. De Lidstaten hadden tot 16 juli 2021 om de Richtlijn in nationale wetgeving op te nemen, maar in Nederland is dat nog niet gebeurd. Tot 6 februari 2022 vond een [internetconsultatie over de ontwerptekst voor de nieuwe Wet Hergebruik Overheidsinformatie](https://www.internetconsultatie.nl/wetimplementatieopendatarichtlijn/b1) plaats die de ODD in Nederlandse wetgeving omzet. In september 2021 is de EC een zogenaamde _infringement procedure_ tegen Nederland (en veel andere Lidstaten) gestart omdat omzetting niet op tijd heeft plaatsgevonden. Op 15 februari 2023 is de zaak door de EC bij het Europese Hof aanhangig gemaakt. De huidige verwachting is dat de Nederlandse Hergebruikswet tegen de zomer van 2023 naar de Tweede Kamer zal worden gezonden.
...
Data, die op de EU High Value Data lijst wordt genoemd, moet verplicht door alle Lidstaten, mits voorhanden, als open data worden gepubliceerd en ontsloten via APIs (zoals beschreven in hoofdstuk 5 van de [ODD](#open-data-directive)). Het betreft een uitvoerings<em>verordening</em>, en deze heeft kracht van wet ongeacht de omzetting van de Open Data Directive in de Nederlandse Wet Hergebruik van Overheidsinformatie. De wettelijke verplichtingen van de High Value Data lijst staan volledig op zichzelf.
...
Op 21 december 2022 is de uitvoeringsverordening [gepubliceerd](https://eur-lex.europa.eu/legal-content/NL/TXT/HTML/?uri=PI_COM:C(2022)9562&from=EN). De uitvoeringsverordening ging 20 dagen na publicatie in. De open data eisen moeten uiterlijk 16 maanden later, d.w.z. per april 2024 door iedere Lidstaat vervuld zijn. In Nederland zijn de leden van het Tactisch Beraad de implementatieperiode van de High Value Data lijst feitelijk al eerder begonnen. Vanuit het Ministerie van Binnenlandse Zaken is een impactanalyse gevraagd aan de betrokken datahouders. Geonovum heeft een hulpmiddel geschreven voor die impactanalyse ([PDF Template_uitvoeringstoets](https://docs.geostandaarden.nl/eu/hvdl/230214Template_uitvoeringstoets_HVDL.pdf)), en enkele aanvullende [factsheets](https://docs.geostandaarden.nl/eu/hvdl/) waarin bepaalde aspecten van de High Value Datalijst worden toegelicht.
...
- Water
	...
	- Articles 6-11, 13, 14, 17-19, 26, 27 of Directive 2008/56/EC marine environmental policy (Marine Strategy Framework)
...
- Overheidsuitgaven en inkomsten, overheidsschulden
- Milieustatistieken
- Bevolking, vruchtbaarheid, en sterfte
- Zorguitgaven
- Armoedecijfers
- Ongelijkheidsgegevens
- Arbeidsmarkt (werkenden, werklozen, beroepsbevolking)

Voor elk van deze onderwerpen wordt gedetailleerd weergegeven wat en hoe er gepubliceerd moet worden.

##### Bedrijven en bedrijfseigendom
