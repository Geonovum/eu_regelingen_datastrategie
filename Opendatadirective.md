...
De implementatiewet bepaalt in haar bijlage (Annex I) de data die verplicht als open data moet worden gepubliceerd. Voor die datasets bepaalt de wet de eisen die worden gesteld aan publicatie en gebruik van die datasets, waaronder de minimumeisen aan ontsluiting via een API.

- De genoemde data moet via een API machineleesbaar worden ontsloten, en waar aangegeven ook voor bulk download.
